...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-gray-800 dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-10 px-12 py-7"
    >
      {children}
    </nav>
  );
